...
@__const.main.my_test_variable = private unnamed_addr constant [12 x i8] c"Hello world\00", align 1
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %3, i8* align 1 getelementptr inbounds ([12 x i8], [12 x i8]* @__const.main.my_test_variable, i32 0, i32 0), i64 12, i1 false)
  %4 = getelementptr inbounds [12 x i8], [12 x i8]* %2, i64 0, i64 0
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %4)
  ret i32 0
}
